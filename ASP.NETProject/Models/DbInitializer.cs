        ...
        public static void Seed(AppDbContext context)
        {
            if (!context.Monitors.Any())
            {
                ...
                (
                    ...
                    new Monitor { Name = "ASUS ROG STRIX XG27VQ", Price = 379.00, DisplaySize = 27, Color = "Black", SoldBy = "Amazon.co.uk", ModelYear = 2017, ImageThumbnailUrl = "https://images-eu.ssl-images-amazon.com/images/I/41RR7fJLgWL._SL500_AC_SS350_.jpg", ImageUrl = "https://images-na.ssl-images-amazon.com/images/I/91A45H86Z4L._SL1500_.jpg" },
